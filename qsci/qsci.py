...
class QSCI:
    ...
    def diagonalize(self):
        ...
        norb = self.norb
        nelec = self.nelec
        h2e = fci.direct_spin1.absorb_h1e(self.int1e, self.int2e, norb, nelec, .5)
    ...
    def diagonalize_sci(self, nroots=1):
        ...
        e, c = kernel_fixed_space(myci, self.int1e, self.int2e, self.norb, self.nelec, c1._strs, nroots=nroots)
        if nroots == 1:
            self.c = c
        else:
            self.c = c[nroots-1]
